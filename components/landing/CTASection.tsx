...
export function CTASection() {
  return (
    <>
      ...
      {/* CTA Content */}
      <section className="w-full max-w-[1200px] mx-auto px-[300px] py-[120px] border-t-[0.5px] border-[#E9E9E9]">
        <div className="flex flex-col items-center gap-10">
          ...
          <Link
            href="/signup"
            className="w-full flex items-center justify-center gap-0.5 px-[22px] py-3.5 bg-[#485C11] rounded-[1000px] text-white hover:bg-[#485C11]/90 transition-colors"
          >
