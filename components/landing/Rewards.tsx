...
export function Rewards() {
  return (
    <section className="w-full max-w-[1200px] mx-auto pb-[80px] md:pb-[120px]">
      <div className="flex flex-col gap-[80px] md:gap-20 pt-[80px] md:pt-20 border-t border-[#E9E9E9]">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-[40px] md:gap-0">
        ...
        {/* Rewards Grid - horizontal scroll on mobile */}
        <div className="flex gap-5 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 -mx-4 px-4 md:mx-0 md:px-0">
          {rewards.map((reward, index) => (
            <section
              key={index}
              aria-label={`Step ${index + 1} of 4`}
              className="flex-1 min-w-[240px] md:min-w-60 flex flex-col gap-[60px] pt-[60px] pb-5 pr-[30px] border-t border-[#E9E9E9] flex-shrink-0"
            >
